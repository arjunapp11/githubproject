...
import com.web.model.EmployeeForm;
...
public class EmployeeDAO {
	...
	private static void initEmps() {
		Employee emp1 = new Employee(1L, "E01", "Arjun", "Shirsat");
		Employee emp2 = new Employee(2L, "E02", "Amit", "jadhav");
		Employee emp3 = new Employee(3L, "E03", "Rahul", "Kharat");
